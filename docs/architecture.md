...
- El dashboard sincroniza de forma segura el ciclo de vida: un viaje pasa a `completed` el día posterior a su regreso, según su zona horaria IANA. La operación solo puede afectar viajes de los que la persona autenticada ya es integrante.
